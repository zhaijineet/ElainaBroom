...
public class ElainaBroomEntity extends Entity {
    ...
    public void readAdditionalSaveData(CompoundTag compoundTag) {
        ...
        if (compoundTag.contains("BroomStack")) {
            this.broomStack = ItemStack.parseOptional(this.registryAccess(), compoundTag.getCompound("BroomStack"));
        }
    }
    ...
    public void addAdditionalSaveData(CompoundTag compoundTag) {
        ...
        if (!this.broomStack.isEmpty()) {
            compoundTag.put("BroomStack", this.broomStack.save(this.registryAccess()));
        }
    }
