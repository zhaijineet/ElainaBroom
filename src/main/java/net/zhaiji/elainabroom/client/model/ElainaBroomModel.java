...
import net.zhaiji.elainabroom.client.render.ElainaBroomRenderState;

public class ElainaBroomModel extends EntityModel<ElainaBroomRenderState> {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(Identifier.fromNamespaceAndPath(ElainaBroom.MOD_ID, "main"), "broom");
    ...
    @Override
    public void setupAnim(ElainaBroomRenderState state) {
    }
}